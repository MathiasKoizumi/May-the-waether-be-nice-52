...
namespace WindowsFormsApplication1
{
	public class Form1 : Form
	{
		...
		{
			Stream manifestResourceStream = myAssembly.GetManifestResourceStream("WindowsFormsApplication1.Resources.Images.butterfly.png");
			...
			for (int i = 0; i < 1280; i++)
			{
				...
				{
				case 0:
					num3 += junkie.Next(2, 4);
					break;
				case 1:
					num3 += junkie.Next(1, 3);
					break;
				}
				array[i] = kukur.testMeYO() + " ";
				string[] array2;
				IntPtr value;
				(array2 = array)[(int)(value = (IntPtr)i)] = array2[(int)value] + kukur.testMeYO() + " ";
				string[] array3;
				IntPtr value2;
				(array3 = array)[(int)(value2 = (IntPtr)i)] = array3[(int)value2] + kukur.testMeYO() + " ";
				string[] array4;
				IntPtr value3;
				(array4 = array)[(int)(value3 = (IntPtr)i)] = array4[(int)value3] + kukur.testMeYO() + " ";
				string[] array5;
				IntPtr value4;
				(array5 = array)[(int)(value4 = (IntPtr)i)] = array5[(int)value4] + kukur.testMeYO() + " ";
				string[] array6;
				IntPtr value5;
				(array6 = array)[(int)(value5 = (IntPtr)i)] = array6[(int)value5] + kukur.testMeYO() + " ";
				if (i == 700)
				{
					File.WriteAllLines("C:\\test\\Shislak.txt", array);
				}
				Graphics graphics2 = Graphics.FromImage(image2);
				graphics2.InterpolationMode = InterpolationMode.HighQualityBicubic;
				graphics2.DrawImage(bitmap, 0, 0);
				graphics2.DrawString(array[0], new Font("Segoe Script", 22f, FontStyle.Bold), Brushes.White, new PointF(200f, (int)(1000.0 - num)));
				graphics2.DrawString(array[1], new Font("Segoe Script", 22f, FontStyle.Bold), Brushes.White, new PointF(200f, (int)(1000.0 - num + 40.0)));
				graphics2.DrawString(array[2], new Font("Segoe Script", 22f, FontStyle.Bold), Brushes.White, new PointF(200f, (int)(1000.0 - num + 80.0)));
				graphics2.DrawString(array[3], new Font("Segoe Script", 22f, FontStyle.Bold), Brushes.White, new PointF(200f, (int)(1000.0 - num + 120.0)));
				graphics2.DrawString(array[7], new Font("Segoe Script", 22f, FontStyle.Bold), Brushes.White, new PointF(200f, (int)(1000.0 - num + 160.0)));
				graphics2.DrawString(array[8], new Font("Segoe Script", 22f, FontStyle.Bold), Brushes.White, new PointF(200f, (int)(1000.0 - num + 200.0)));
				graphics2.DrawString(array[9], new Font("Segoe Script", 22f, FontStyle.Bold), Brushes.White, new PointF(200f, (int)(1000.0 - num + 240.0)));
				graphics2.DrawString(array[10], new Font("Segoe Script", 22f, FontStyle.Bold), Brushes.White, new PointF(200f, (int)(1000.0 - num + 280.0)));
				graphics2.DrawString(array[11], new Font("Segoe Script", 22f, FontStyle.Bold), Brushes.White, new PointF(200f, (int)(1000.0 - num + 320.0)));
				graphics2.DrawString(array[12], new Font("Segoe Script", 22f, FontStyle.Bold), Brushes.White, new PointF(200f, (int)(1000.0 - num + 360.0)));
				graphics2.DrawString(array[13], new Font("Segoe Script", 22f, FontStyle.Bold), Brushes.White, new PointF(200f, (int)(1000.0 - num + 400.0)));
				graphics2.DrawString(array[14], new Font("Segoe Script", 22f, FontStyle.Bold), Brushes.White, new PointF(200f, (int)(1000.0 - num + 440.0)));
				graphics2.DrawString(array[4], new Font("Segoe Script", 22f, FontStyle.Bold), Brushes.White, new PointF(200f, (int)(1000.0 - num + 480.0)));
				graphics2.DrawString(array[5], new Font("Segoe Script", 22f, FontStyle.Bold), Brushes.White, new PointF(200f, (int)(1000.0 - num + 520.0)));
				graphics2.DrawString(array[51], new Font("Segoe Script", 22f, FontStyle.Bold), Brushes.White, new PointF(200f, (int)(1000.0 - num + 560.0)));
				graphics2.DrawString(array[69], new Font("Segoe Script", 22f, FontStyle.Bold), Brushes.White, new PointF(200f, (int)(1000.0 - num + 600.0)));
				graphics2.DrawString(array[15], new Font("Segoe Script", 22f, FontStyle.Bold), Brushes.White, new PointF(200f, (int)(1000.0 - num + 640.0)));
				graphics2.DrawString(array[16], new Font("Segoe Script", 22f, FontStyle.Bold), Brushes.White, new PointF(200f, (int)(1000.0 - num + 680.0)));
				graphics2.DrawString(array[17], new Font("Segoe Script", 22f, FontStyle.Bold), Brushes.White, new PointF(200f, (int)(1000.0 - num + 720.0)));
				graphics2.DrawString(array[18], new Font("Segoe Script", 22f, FontStyle.Bold), Brushes.White, new PointF(200f, (int)(1000.0 - num + 760.0)));
				graphics2.DrawString(array[19], new Font("Segoe Script", 22f, FontStyle.Bold), Brushes.White, new PointF(200f, (int)(1000.0 - num + 800.0)));
				graphics2.DrawString(array[20], new Font("Segoe Script", 22f, FontStyle.Bold), Brushes.White, new PointF(200f, (int)(1000.0 - num + 840.0)));
				graphics2.DrawString(array[21], new Font("Segoe Script", 22f, FontStyle.Bold), Brushes.White, new PointF(200f, (int)(1000.0 - num + 880.0)));
				graphics2.DrawString(array[22], new Font("Segoe Script", 22f, FontStyle.Bold), Brushes.White, new PointF(200f, (int)(1000.0 - num + 920.0)));
				graphics2.DrawString("Grammar correct 100%....lol :)", new Font("Verdana", 24f), Brushes.White, new PointF(200f, (int)(1000.0 - num + 1270.0)));
				graphics2.DrawImage(image, -800 + num3, (float)(300.0 + num2));
				graphics2.DrawString("60.7 billiard estimates in three words, what?!?!?.....:)!!!!", new Font("Verdana", 24f), Brushes.White, new PointF(200f, (float)(950.0 - num)));
				graphics2.Save();
		...
		{
			Assembly executingAssembly = Assembly.GetExecutingAssembly();
			Stream manifestResourceStream = executingAssembly.GetManifestResourceStream("WindowsFormsApplication1.Resources.Images.1.jpg");
			Image image = Image.FromStream(manifestResourceStream);
			switch (junkie.Next(7))
			{
			case 0:
				manifestResourceStream = executingAssembly.GetManifestResourceStream("WindowsFormsApplication1.Resources.Images.1.jpg");
				image = Image.FromStream(manifestResourceStream);
				break;
			case 1:
				manifestResourceStream = executingAssembly.GetManifestResourceStream("WindowsFormsApplication1.Resources.Images.man.jpg");
				image = Image.FromStream(manifestResourceStream);
				break;
			case 2:
				manifestResourceStream = executingAssembly.GetManifestResourceStream("WindowsFormsApplication1.Resources.Images.woman.jpg");
				image = Image.FromStream(manifestResourceStream);
				break;
			case 3:
				manifestResourceStream = executingAssembly.GetManifestResourceStream("WindowsFormsApplication1.Resources.Images.blob.jpg");
				image = Image.FromStream(manifestResourceStream);
				break;
			case 4:
				manifestResourceStream = executingAssembly.GetManifestResourceStream("WindowsFormsApplication1.Resources.Images.homeless.jpg");
				image = Image.FromStream(manifestResourceStream);
				break;
			case 5:
				manifestResourceStream = executingAssembly.GetManifestResourceStream("WindowsFormsApplication1.Resources.Images.numse.jpg");
				image = Image.FromStream(manifestResourceStream);
				break;
			case 6:
				manifestResourceStream = executingAssembly.GetManifestResourceStream("WindowsFormsApplication1.Resources.Images.potato.jpg");
				image = Image.FromStream(manifestResourceStream);
				break;
			case 7:
			...
			case 11:
				...
				break;
			case 12:
				manifestResourceStream = executingAssembly.GetManifestResourceStream("WindowsFormsApplication1.Resources.Images.Migselfies.jpg");
				image = Image.FromStream(manifestResourceStream);
				break;
			}
			double num = 1.0;
